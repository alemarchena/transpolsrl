...
export default function Personas() {
  ...
  const [tipoVisor, setTipoVisor] = useState(null) // 'pdf' o 'imagen'
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="grid grid-cols-1 md:grid-cols-5 gap-4 mb-6">
        <div className="flex flex-col">
          <input
            ...
            placeholder="Legajo *"
            title="Número de legajo del empleado (obligatorio)"
        ...
        <div className="flex flex-col">
          <input
            ...
            placeholder="DNI *"
            title="Documento Nacional de Identidad (obligatorio)"
        ...
        <div className="flex flex-col">
          <input
            ...
            placeholder="Nombre *"
            title="Nombre de la persona (obligatorio)"
        ...
        <div className="flex flex-col">
          <input
            ...
            title="Apellido de la persona (obligatorio)"
        ...
        <select
          {...register("id_empresa")}
          title="Empresa a la que pertenece la persona"
          className="border px-3 py-2 h-10 rounded text-gray-800 bg-white"
        >
        ...
        <div className="flex flex-col">
          <input
            ...
            type="date"
            title="Fecha de nacimiento de la persona (obligatorio)"
        ...
        <div className="flex flex-col">
          <input
            ...
            type="date"
            title="Fecha de ingreso a la empresa (obligatorio)"
        ...
        <textarea
          ...
          title="Dirección completa de la persona"
        ...
        <div className="flex flex-col">
          <div className="flex">
            <input
              ...
              title="Número de WhatsApp con código de país (Ej: 549261123456)"
        ...
        <button className="bg-blue-600 text-white px-4 py-2 h-10 rounded hover:bg-blue-700 md:col-span-2">
            ...
            <thead className="bg-gray-100">
              <tr>
                <th
                  ...
                  onClick={() => manejarOrdenamiento("legajo")}
                >
                ...
                <th
                  className="p-2 border cursor-pointer hover:bg-gray-200 select-none"
                  onClick={() => manejarOrdenamiento("nacimiento")}
                >
                  Nacimiento {obtenerIconoOrden("nacimiento")}
                </th>
                <th
                  className="p-2 border cursor-pointer hover:bg-gray-200 select-none"
                  onClick={() => manejarOrdenamiento("sexo")}
                >
                  Sexo {obtenerIconoOrden("sexo")}
                </th>
                <th
                  className="p-2 border cursor-pointer hover:bg-gray-200 select-none"
                  onClick={() => manejarOrdenamiento("fecha_ingreso")}
                >
                ...
                <th
                  className="p-2 border cursor-pointer hover:bg-gray-200 select-none"
                  onClick={() => manejarOrdenamiento("empresa")}
                >
